...
/**
 * Classe de localisation des services et ressources implémentant le Design Pattern Singleton
 * 
 */
public class SingleCachingServiceLocator implements IServiceLocator {
     ...
     * Lit les propriétés systèmes si elles sont fournies ou alors le fichier 
     * de configuration JNDI par défaut
     *
     * @return locator
     */
