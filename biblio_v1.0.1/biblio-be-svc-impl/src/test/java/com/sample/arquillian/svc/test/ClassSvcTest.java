...
import com.sample.biblio.dao.impl.constant.be.BiblioSvcMessageKey;
...
public class ClassSvcTest {
    ...
    public void testCreationPourTestRollbackTransac1() throws GenericException{
        ...
        exception.expect(BiblioSvcExceptionForTestTransact.class);
